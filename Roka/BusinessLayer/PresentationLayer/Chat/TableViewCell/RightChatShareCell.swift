//
//  RightChatShareCell.swift
//  Roka
//
//  Created by Applify  on 27/12/22.
//

import UIKit

class RightChatShareCell: UITableViewCell {
    ...
    static let identifier = "RightChatShareCell"
...
//        }
        lblMessage.text = "You have shared some dating profiles."
