...
class RightChatImageReplyCell: UITableViewCell {
    ...
    static let identifier = "RightChatImageReplyCell"
    ...
    private func setUpUI() {
        DispatchQueue.main.async {
            self.mainBubbleView.roundCorners(radius: 10, corners: [.layerMinXMinYCorner, .layerMaxXMinYCorner, .layerMinXMaxYCorner] )
